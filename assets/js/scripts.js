// document.querySelector('.dots-navigation a').addEventListener('click', function (event) {
//     event.preventDefault();
//     let id  = document.querySelector(this).getAttribute('href'),
//         top = window.pageYOffset + document.querySelector(id).getBoundingClientRect().top;
